...
| | |
|:---:|:---:|
| ![用户端-首页](./readme/client-01.png) | ![用户端-链接管理](./readme/client-02.png) |
| ![用户端-链接详情](./readme/client-03.png) | ![用户端-数据统计](./readme/client-04.png) |

### 管理员

| | |
|:---:|:---:|
| ![管理员-全局统计](./readme/server-01.png) | ![管理员-链接管理](./readme/server-02.png) |
| ![管理员-登录日志](./readme/server-03.png) | ![管理员-用户管理](./readme/server-04.png) |
