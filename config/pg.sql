...
CREATE OR REPLACE VIEW "public"."link_stats" WITH ("security_invoker"='false') AS
 SELECT "l"."id",
    "l"."short",
    "l"."link",
    "l"."user_id",
    "l"."created_at",
    "l"."click_count",
    "count"(DISTINCT "date_trunc"('day'::"text", "lal"."accessed_at")) AS "active_days",
...
ALTER TABLE "public"."link_stats" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."links_duplicate" (
    "link" "text" NOT NULL,
    "short" "text" NOT NULL,
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
...
ALTER TABLE "public"."links_duplicate" OWNER TO "postgres";


COMMENT ON TABLE "public"."links_duplicate" IS 'This is a duplicate of links';



ALTER TABLE "public"."links_duplicate" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."links_duplicate_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE OR REPLACE VIEW "public"."user_link_stats" WITH ("security_invoker"='false') AS
 SELECT "l"."user_id",
    "count"("l"."id") AS "total_links",
    COALESCE("sum"("l"."click_count"), (0)::numeric) AS "total_clicks",
    "count"(
        CASE
            WHEN ("l"."created_at" >= ("now"() - '7 days'::interval)) THEN 1
            ELSE NULL::integer
        END) AS "weekly_new_links",
    "round"(COALESCE("avg"("l"."click_count"), (0)::numeric), 2) AS "avg_clicks_per_link"
   FROM "public"."links" "l"
  WHERE ("l"."user_id" IS NOT NULL)
  GROUP BY "l"."user_id";


ALTER TABLE "public"."user_link_stats" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."links_duplicate"
    ADD CONSTRAINT "links_duplicate_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "links_duplicate_expires_at_idx" ON "public"."links_duplicate" USING "btree" ("expires_at");



CREATE INDEX "links_duplicate_short_idx" ON "public"."links_duplicate" USING "btree" ("short");



CREATE INDEX "links_duplicate_user_id_idx" ON "public"."links_duplicate" USING "btree" ("user_id");
...
ALTER TABLE "public"."links_duplicate" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON TABLE "public"."link_stats" TO "anon";
GRANT ALL ON TABLE "public"."link_stats" TO "authenticated";
GRANT ALL ON TABLE "public"."link_stats" TO "service_role";



GRANT ALL ON TABLE "public"."links_duplicate" TO "anon";
GRANT ALL ON TABLE "public"."links_duplicate" TO "authenticated";
GRANT ALL ON TABLE "public"."links_duplicate" TO "service_role";



GRANT ALL ON SEQUENCE "public"."links_duplicate_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."links_duplicate_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."links_duplicate_id_seq" TO "service_role";
...
GRANT ALL ON TABLE "public"."user_link_stats" TO "anon";
GRANT ALL ON TABLE "public"."user_link_stats" TO "authenticated";
GRANT ALL ON TABLE "public"."user_link_stats" TO "service_role";
