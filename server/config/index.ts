...
export const CORS_CONFIG = {
	...
	// 允许的请求头
	ALLOWED_HEADERS: ["Content-Type", "Authorization", "X-Requested-With"] as const,
	// 暴露给客户端的响应头
	EXPOSED_HEADERS: ["X-RateLimit-Limit", "X-RateLimit-Remaining", "X-RateLimit-Reset"] as const,
	// 预检请求缓存时间（秒）
	MAX_AGE: 86400,
	// 是否允许携带凭证
	CREDENTIALS: true,
...
export const SECURITY_CONFIG = {
	// 危险端口列表（SSRF 保护）
	DANGEROUS_PORTS: [22, 23, 25, 110, 143, 445, 3306, 5432, 6379, 27017] as const,
	// 禁止的协议
	BLOCKED_PROTOCOLS: ["javascript", "vbscript", "data", "file", "ftp", "mailto", "tel"] as const,
	// 云服务元数据端点
	BLOCKED_HOSTNAMES: [
